...
def cryptDecrypt():
        ...
        originalText = descifra(textCipher,n,d)
        ...
        with open('decryp_file.txt', 'w') as f:
            for item in originalText:
                f.write("%s" % item)
        ...
        print("q:", q)
        print("n:", n)
        print("Totie: ",totienteN)
        print("e:", e)
        print("d:", d, " Modular multi inverso")
        f.closed
